...
<p>Total duration of examination is 60 minutes. (20 minutes extra for every 60 minutes (1 hour) of the examination time for candidates with disability eligible for compensatory time).
...
Candidate can view the corresponding section summary as part of the legend that appears in every section above the question palette.
						...
						<a href="<?php echo URL; ?>indexPage/instructionsNext" type="button" class="btn btn-primary">Next</a>